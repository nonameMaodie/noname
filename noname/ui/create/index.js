...
class Create {
  ...
  async editor(config = {}) {
    ...
    const { EditorView } = await __vitePreload(async () => {
      const { EditorView: EditorView2 } = await import("../../../node_modules/.pnpm/@codemirror_view@6.39.4/node_modules/@codemirror/view/dist/index.js");
    ...
    const { linter, lintGutter } = await __vitePreload(async () => {
      const { linter: linter2, lintGutter: lintGutter2 } = await import("../../../node_modules/.pnpm/@codemirror_lint@6.9.2/node_modules/@codemirror/lint/dist/index.js");
    ...
    const { search, highlightSelectionMatches, openSearchPanel } = await __vitePreload(async () => {
      const { search: search2, highlightSelectionMatches: highlightSelectionMatches2, openSearchPanel: openSearchPanel2 } = await import("../../../node_modules/.pnpm/@codemirror_search@6.5.11/node_modules/@codemirror/search/dist/index.js");
    ...
    if (language === "javascript" || language === "typescript") {
      ...
      const { parseMixed } = await __vitePreload(async () => {
        const { parseMixed: parseMixed2 } = await import("../../../node_modules/.pnpm/@lezer_common@1.4.0/node_modules/@lezer/common/dist/index.js");
        return { parseMixed: parseMixed2 };
      }, true ? [] : void 0, import.meta.url);
      const { LRLanguage } = await __vitePreload(async () => {
        const { LRLanguage: LRLanguage2 } = await import("../../../node_modules/.pnpm/@codemirror_language@6.11.3/node_modules/@codemirror/language/dist/index.js");
  ...
  arena() {
    ...
    if (lib.config.keep_awake) {
      if (window.plugins && window.plugins.insomnia) {
        ...
        __vitePreload(async () => {
          const { default: NoSleep } = await import("../../../_virtual/index5.js").then((n) => n.i);
